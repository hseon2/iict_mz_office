...
function Meeting() {
  ...
  image(game_header, width / 2, height / 2);
  rectMode(CORNER);
  fill(255, 237, 190);
  ...
  if (peerState.p1) {
    ...
    imageMode(CENTER);
    image(peer11, width / 2, height / 2);
  }

  if (peerState.p2) {
    imageMode(CENTER);
    image(peer2, width / 2, height / 2);
    ...
    imageMode(CENTER);
    image(peer22, width / 2, height / 2);
  }

  if (peerState.p3) {
    imageMode(CENTER);
    image(peer3, width / 2, height / 2);
    ...
    imageMode(CENTER);
    image(peer33, width / 2, height / 2);
  }

  if (peerState.p4) {
    imageMode(CENTER);
    image(peer4, width / 2, height / 2);
